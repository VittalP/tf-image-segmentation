...
if machine == 'ccvl-4gpu':
    ...
    flags.DEFINE_string("log_dir", "/home-4/vpremac1@jhu.edu/projects/tf-image-segmentation/log_dir/" + exp_name, "Directory to save TF logs")
    flags.DEFINE_string("save_dir", "/home-4/vpremac1@jhu.edu/projects/tf-image-segmentation/save_dir/" + exp_name, "Directory to save checkpoint models")
